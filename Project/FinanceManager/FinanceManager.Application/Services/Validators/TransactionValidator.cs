...
public class TransactionValidator : ITransactionValidator
{
    ...
    public async Task ValidateAsync(ITransactionableCommand transactionCommand, CancellationToken cancellationToken)
    {
        ...
        if (!(await _accountValidator.ExistsAsync(transactionCommand.AccountId, cancellationToken)))
